...
_ADVISORY_PATTERNS: List[str] = [
    r"\b(mua|bán|có nên mua|có nên bán|nên mua|nên bán)\b",
    r"\b(tư vấn|khuyến nghị|khuyến cáo)\b.*\b(mã|cổ phiếu|chứng khoán)\b",
    r"\b(đầu tư vào|rót tiền vào|xuống tiền)\b",
    r"\b(giá mục tiêu|target price|stop.?loss|cắt lỗ|chốt lời)\b",
    r"\b(hold|buy|sell|tích lũy|phân phối)\b.*\b(mã|cổ phiếu|cp)\b",
    r"\bcó tiềm năng (tăng|giảm|sinh lời)\b",
    r"\bphân tích (kỹ thuật|cơ bản|fundamental|technical)\b.*\b[A-Z]{2,5}\b",
    r"\b(triển vọng|tiềm năng|rủi ro)\b.*\b(đầu tư|cổ phiếu)\b",
    r"\b(danh mục|portfolio|allocation)\b.*(phân bổ|điều chỉnh)\b",
    r"\bnên giữ hay bán\b",
]

_KNOWLEDGE_PATTERNS: List[str] = [
    r"\b(là gì|định nghĩa|khái niệm|giải thích|ý nghĩa)\b",
    r"\b(pháp luật|quy định|thông tư|nghị định|luật chứng khoán)\b",
    r"\b(cách tính|công thức|phương pháp tính)\b",
    r"\b(RSI|MACD|EMA|SMA|P/E|P/B|ROE|ROA|EPS|EBITDA)\b.*\b(là gì|nghĩa là|tính như)\b",
    r"\b(chứng khoán phái sinh|ETF|trái phiếu|cổ tức|quyền mua)\b.*\b(là gì|như thế nào)\b",
    r"\b(cách|hướng dẫn|quy trình|thủ tục)\b.*(đặt lệnh|mở tài khoản|nộp thuế)\b",
    r"\b(báo cáo tài chính|bctc|tài chính doanh nghiệp)\b",
    r"\b(ủy ban chứng khoán|SSC|HoSE|HNX|UPCOM)\b",
    r"\b(T\+[0-9]|lệnh|khớp lệnh|thanh toán)\b.*(hoạt động|như thế nào|là gì)\b",
